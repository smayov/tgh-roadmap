...
/* ============================================================
   ...
   Reutiliza los datos y estilos del catálogo, pero:
   - NO requiere sesión (es el escaparate para visitantes).
   - NO contrata: el botón lleva a /acceso a crear cuenta.
    ...
    <div className="tgh-root">
      ...
      <div className="tgh-wrap">
        ...
        <section className="hero">
          <div>
            <span className="eyebrow"><span className="dot" /> Calculadora de precios</span>
            <h1>Monta <em>tu suite</em>.</h1>
            <p className="lead">Elige los módulos que necesitas y descubre tu precio al instante. Sin compromiso — para contratar, crea tu cuenta.</p>
          </div>
        ...
        <section className="config" id="config">
          <div>
            ...
            <p className="config-intro">
              Prueba distintas combinaciones y mira cuánto costaría. El panel de <b>Salud Financiera</b> está incluido en todos los planes, sin coste.
            </p>
...
.tgh-root .sim-note{font-size:.76rem;color:rgba(234,243,236,.55);margin-top:12px;text-align:center;line-height:1.4}
