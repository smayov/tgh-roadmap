...
export async function identificarPorPin(negocioId, pin) {
  ...
  return {
    ...
    tipoFichaje: empleado.tipo_fichaje,
  };
}
...
export async function ficharConPin(negocioId, pin, ubicacion) {
  ...
  // 👇 Novedad: devolvemos también tipo_fichaje, para que la pantalla sepa
  // si ofrecer la instalación de la PWA (solo tiene sentido para movilidad)
  return {
    ok: true,
    nombre: empleado.nombre,
    tipo,
